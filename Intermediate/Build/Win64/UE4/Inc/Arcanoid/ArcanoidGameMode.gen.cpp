...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AArcanoidGameMode()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
				...
				{ "IncludePath", "ArcanoidGameMode.h" },
				{ "ModuleRelativePath", "ArcanoidGameMode.h" },
				{ "ShowCategories", "Input|MouseInput Input|TouchInput" },
				{ "ToolTip", "The GameMode defines the game being played. It governs the game rules, scoring, what actors\nare allowed to exist in this game type, and who may enter the game.\n\nThis game mode just sets the default pawn to be the MyCharacter asset, which is a subclass of ArcanoidCharacter" },
			};
#endif
	...
	IMPLEMENT_CLASS(AArcanoidGameMode, 2339437184);
