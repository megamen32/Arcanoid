...
// Cross Module References
	...
	ARCANOID_API UClass* Z_Construct_UClass_UGravityWire_NoRegister();
	ARCANOID_API UClass* Z_Construct_UClass_UGravityWire();
// End Cross Module References
	...
	void UGravityWire::StaticRegisterNativesUGravityWire()
	{
	}
	UClass* Z_Construct_UClass_UGravityWire_NoRegister()
	{
		return UGravityWire::StaticClass();
	}
	UClass* Z_Construct_UClass_UGravityWire()
	{
		static UClass* OuterClass = nullptr;
		if (!OuterClass)
		{
			static UObject* (*const DependentSingletons[])() = {
				(UObject* (*)())Z_Construct_UClass_UPhysicsEffect,
				(UObject* (*)())Z_Construct_UPackage__Script_Arcanoid,
			};
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_body = { UE4CodeGen_Private::EPropertyClass::Object, "body", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000005, 1, nullptr, STRUCT_OFFSET(UGravityWire, body), Z_Construct_UClass_AShapeBase_NoRegister, METADATA_PARAMS(NewProp_body_MetaData, ARRAY_COUNT(NewProp_body_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_body,
			};
			static const FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
				TCppClassTypeTraits<UGravityWire>::IsAbstract,
			};
			static const UE4CodeGen_Private::FClassParams ClassParams = {
				&UGravityWire::StaticClass,
				DependentSingletons, ARRAY_COUNT(DependentSingletons),
				0x00A00080u,
				nullptr, 0,
				PropPointers, ARRAY_COUNT(PropPointers),
	...
	IMPLEMENT_CLASS(UGravityWire, 3929217103);
	static FCompiledInDefer Z_CompiledInDefer_UClass_UGravityWire(Z_Construct_UClass_UGravityWire, &UGravityWire::StaticClass, TEXT("/Script/Arcanoid"), TEXT("UGravityWire"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(UGravityWire);
